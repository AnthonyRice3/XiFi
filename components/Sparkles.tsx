...
export function Sparkles() {
  return (
    <div className="h-[40rem] py-12 w-ful flex flex-col items-center justify-center overflow-hidden rounded-md">
      <h1 className="md:text-7xl text-3xl lg:text-9xl font-bold text-center text-zinc-400 relative z-20 pt-60">
        Let&apos;s ProXiFi
      </h1>
      <div className="w-[40rem] h-40 relative">
        ...
        <div className="absolute inset-0 w-full h-full [mask-image:radial-gradient(350px_200px_at_top,transparent_20%,yellow)]"></div>
      </div>
    </div>
  );
}
