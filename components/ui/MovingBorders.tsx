...
type ButtonProps = {
  ...
  as?: ElementType; // more precise than `any`
  containerClassName?: string;
  borderClassName?: string;
  duration?: number;
  className?: string;
} & React.HTMLAttributes<HTMLElement>; // enables support for native props like `onClick`
    ...
    >
      ...
      >
        <MovingBorder duration={duration} rx="30%" ry="30%">
          <div
            className={cn(
              "h-20 w-20 opacity-[0.8] bg-[radial-gradient(#f59e0b_40%,transparent_60%)]",
              borderClassName
            )}
          />
        </MovingBorder>
...
type MovingBorderProps = {
  ...
  rx?: string;
  ry?: string;
} & React.SVGProps<SVGSVGElement>; // allows SVG-related props like `viewBox`, `width`, `height`
