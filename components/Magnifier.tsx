...
export function Magnifier() {
  ...
  return (
    <div>
      <div className="w-full relative rounded-3xl overflow-hidden max-w-md mx-auto bg-gradient-to-r from-[#1D2235] to-[#121318] p-10 md:p-12 my-10">
        <Rays />
        <Beams />
  ...
  return (
    ...
    >
      <g filter="url(#filter0_f_120_7473)">
        <circle cx="34" cy="52" r="114" fill="#F59E0B" />
      </g>
      <g filter="url(#filter1_f_120_7473)">
        <circle cx="332" cy="24" r="102" fill="#B45309" />
      </g>
      <g filter="url(#filter2_f_120_7473)">
        <circle cx="191" cy="53" r="102" fill="#FDE68A" />
      </g>
      <defs>
        <filter
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop offset="0.214779" stopColor="#F59E0B" />
          <stop offset="0.781583" stopColor="#FDE68A" stopOpacity="0" />
        </linearGradient>
        <linearGradient
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0.214779" stopColor="#FDE68A" />
          <stop offset="0.781583" stopColor="#FDE68A" stopOpacity="0" />
        </linearGradient>
        <linearGradient
